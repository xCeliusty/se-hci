...
<h1 class="view_patient_Profile_Title">Edit Medical form for<?php echo $_GET['Pname']." " .$_GET['Pid'];?> </h1>
...
<?php
     ...
     if(isset($_POST['submit']))
     {
         ...
         $sq =mysqli_query($db_handle->conn,"UPDATE medical_history SET surgeries='$surgeries', allergy='$allergy', pregnant='$pregnant', diagnosis='$diagnosis',breast_feeding='$breast_feeding' WHERE get_patient_id='$get_patient' ");
